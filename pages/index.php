        ...
        <div class="col-lg right-col">
          <div class="wrapper-card" id="loginmode">
            <div class="title d-flex justify-content-between align-items-center" data-aos="fade-down">
              <h1>Smart Home</h1>
              <a href="../pages/register.php" class="ml-sm-auto ml-md-auto ml-lg-auto mt-lg-3 ml-0">Sign Up ></a>
            </div>
              ...
              <div class="login text-center">
                <form action="" method="post">
                  ...
                  <div class="blue-button">
                    <button type="submit" name="login" class="sign-up">Sign In</button>
                    <img src="images/google.png" alt="" class="d-none d-sm-block d-md-block d-lg-block" />
                    <button type="submit" class="mt-4">Log in with Google Account</button>
                  </div>
                  <div class="text-sign-in d-flex mt-3 text-center">
                    <p class="">
                      Don't have an account?
                    </p>
                    <a href="../pages/register.php" class="ml-1"> Sign Up</a>
                  </div>
                </form>
              </div>
            </div>
